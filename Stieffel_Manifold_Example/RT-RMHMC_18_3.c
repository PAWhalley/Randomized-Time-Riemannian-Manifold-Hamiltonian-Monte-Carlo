...
#define d                       18               // V_{d,p} is the manifold of
#define p                       3               // dimension d*p
#define n                       54  //d*p             // dimension
#define dt_max                  0.01              // stepsize
...
void one_RATTLE_step(double dt, double q[n], double v[n], double f[n])
{
...
void one_step_RHMC(double dt, int num_leap, double qold[n], double pold[n], double q[n], double v[n], double f[n])
{
...
int main(int argc, const char * argv[]) {
    ...
    //     printf("%lf \n",q[n-1]);
        ...
        // counter = 0;
        // static int num_leap = 100;

        // for (int num = 0; num<number_of_samples; num++)
        //     { 
    ...
    for (num_leap = 1; num_leap < 101; num_leap++){
        ...
        { 
            ...
            L = ceil(t/dt_max);
            dt = t/L;
            one_step_RHMC(dt,L,qold,pold,q,v,f);
        ...
        printf("%lf %lf ",num_leap*dt_max,IAC);
        printf("\n");
    }
