...
void one_RATTLE_step(double dt, double q[n], double p[n], double f[n])
{
...
void one_step_RHMC(double dt, int num_leap, double qold[n], double pold[n], double q[n], double p[n], double f[n])
{
...
int main(int argc, const char * argv[]) {
    ...
    static double t;
    static double IAC_list_1[number_of_samples],IAC_list_2[number_of_samples],IAC_list_3[number_of_samples];
    static double IAC;
    static double T;
    static double dt;
    static double IAC_1,IAC_2,IAC_3,IAC_MAX;
    static int L;
    ...
    for (num_leap = 1; num_leap < 251; num_leap++){
            ...
            // {
                ...
                { 
                    ...
                    L = ceil(t/dt_max);
                    dt = t/L;
                    one_step_RHMC(dt,L,qold,pold,q,p,f);
                    
                    //IAC computation
                    if (num > burn - 1){
                    IAC_list_1[num-burn] = q[0];
                    IAC_list_2[num-burn] = q[1];
                    IAC_list_3[num-burn] = q[2];                     
                    }
                }
                ...
                //Compute IAC
                IAC_1 = Compute_IAC(IAC_list_1);
                IAC_2 = Compute_IAC(IAC_list_2);
                IAC_3 = Compute_IAC(IAC_list_3);
                ...
                printf("%lf %lf ",2*num_leap*dt_max,IAC_MAX);
                printf("\n");
    }
            }
